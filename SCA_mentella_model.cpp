...
Type objective_function<Type>::operator() ()
{
  ...
  PARAMETER(logM2);
  PARAMETER(palogNA1);       // RE starts here
  ...
  // probit transformations for bounded a50 coefficients (survey selectivity)
 ...
 //} 
  ...
  for(int a=0;a<(7-minAge);++a){              // loop on ages before 7y
    logitPelFA(a)=-20;
  }
